...
Начнем с src папки: в ней должно быть два файла, а именно __init__.py и main.py.
...
Этот файл содержит информацию или метаданные для созданного нами пакета Python.
